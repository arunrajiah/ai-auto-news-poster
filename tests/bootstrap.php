...
define('AANP_PLUGIN_URL', 'https://example.com/wp-content/plugins/arunai-auto-news-poster/');
define('AANP_PLUGIN_FILE', dirname(__DIR__) . '/arunai-auto-news-poster.php');
