...
';
		$attribution .= '<p><strong>Source:</strong> This article was inspired by news from <a href="' . esc_url( $source_article['link'] ) . '" target="_blank" rel="noopener nofollow">' . esc_html( $source_article['source_domain'] ) . '</a></p>
';
		$attribution .= '<p><em>Generated by NewsForge – AI Auto News Poster</em></p>
';
		$attribution .= '</div>';
